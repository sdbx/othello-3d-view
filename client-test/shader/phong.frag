...
#pragma webglue: count(SPOT_LIGHT_SIZE, uSpotLight, maxLength)
#pragma webglue: count(POINT_SHADOW_LIGHT_SIZE, uPointShadowLight, maxLength)
#pragma webglue: count(DIRECTIONAL_SHADOW_LIGHT_SIZE, uDirectionalShadowLight, maxLength)
#pragma webglue: count(SPOT_SHADOW_LIGHT_SIZE, uSpotShadowLight, maxLength)
